...
var style_HammersmithJoints_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_HammersmithJoints_2(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_HammersmithJoints_2rule0_eval_expression(context)) {
        ...
        var style = rules_HammersmithJoints_2(feature, value);
        ;
